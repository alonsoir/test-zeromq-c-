# aRGus NDR — BACKLOG
*Última actualización: DAY 121 — 18 Abril 2026*
...
### DAY 121 (18 Apr 2026) — DEBTs bloqueantes cerrados + nueva deuda DEBT-PRECISION-GATE-001

**fix(provision): circular dependency plugin_signing.pk → plugin-loader cmake ✅** — `provision_plugin_signing_keypair()` llamada antes del bloque cmake de plugin-loader. Idempotencia × 3 certificada.
**DEBT-SEED-AUDIT-001 ✅** — grep exhaustivo: seed ChaCha20 no está en ningún CMakeLists.txt ni fuente C++. Solo runtime mlock()+explicit_bzero().
**DEBT-XGBOOST-TEST-REAL-001 ✅** — TEST-INTEG-XGBOOST-1 con flows reales CIC-IDS-2017 FTP-Patator. BENIGN: 0.000111/0.000120/0.000228 (<0.1). ATTACK: 0.999894/0.999258/0.999904 (>0.5). Gate médico PASADO.
**DEBT-XGBOOST-DDOS-001 ✅** — XGBoost DDoS F1=1.0 Precision=1.0 (sintético DeepSeek 50k flows). 20x más rápido que RF (0.15 vs 6.12 µs/sample).
**DEBT-XGBOOST-RANSOMWARE-001 ✅** — XGBoost Ransomware F1=0.9932 Precision=0.9932 (sintético DeepSeek 3k flows, tolerancia ±0.01 justificada por RF overfitting). 6x más rápido que RF.
**DEBT-SIGN-MODELS-EXTEND-001 ✅** — make sign-models firma 3 modelos Ed25519 64 bytes.
**OBS-3/DEBT-XGBOOST-LATENCY ✅** — docs/xgboost/comparison-table.md: latencia RF vs XGBoost × 3 detectores.
**PAPER-SECTION-4 ✅** — §4.1 CIC-IDS-2017 real + §4.2 DeepSeek sintético con limitaciones explícitas.
**deploy-models añadido a make bootstrap paso 6/8 ✅** — xgboost_cicids2017.ubj → /etc/ml-defender/models/ idempotente.
**DEBT-PRECISION-GATE-001 🔴 ABIERTA** — Precision=0.9875 < 0.99. BLOQUEANTE MERGE. Protocolo Wednesday held-out acordado por Consejo 7/7.
Commits: 5b1a3021 → 55880c7c · Pubkey activa DAY 121: `fc895faac3e8c533d0cf4463637bbb1d2a3fb09dc6e84f7282dc427dd876f238`
...
### P0 — BLOQUEANTES feature/adr026-xgboost (DAY 122 prioritarios)

| ID | Tarea | Test de cierre | Origen |
|----|-------|---------------|--------|
| **DEBT-PRECISION-GATE-001** | XGBoost level1 Precision=0.9875 < 0.99 (gate médico ADR-026). **BLOQUEANTE MERGE.** Protocolo Consejo 7/7: (1) Train=Tuesday+Thursday+Friday, (2) Validation=20% train para calibrar threshold, (3) Test=Wednesday BLIND una sola vez, (4) Si Precision≥0.99 → merge, si no → iterar. Nunca calibrar threshold sobre test set (data snooping). | XGBoost level1 Precision≥0.99 en Wednesday held-out | Consejo UNÁNIME 7/7 DAY 121 |
...
ADR-026 PASO 4e TEST-INTEG-XGBOOST-1: ████████████████████ 100% ✅  DAY 121 — gate médico PASADO
DEBT-XGBOOST-TEST-REAL-001:            ████████████████████ 100% ✅  DAY 121
DEBT-SEED-AUDIT-001:                   ████████████████████ 100% ✅  DAY 121
DEBT-XGBOOST-DDOS-001:                 ████████████████████ 100% ✅  DAY 121
DEBT-XGBOOST-RANSOMWARE-001:           ████████████████████ 100% ✅  DAY 121
PAPER-SECTION-4 (real vs sintético):   ████████████████████ 100% ✅  DAY 121
DEBT-PRECISION-GATE-001:               ░░░░░░░░░░░░░░░░░░░░   0% 🔴  BLOQUEANTE MERGE DAY 122
...
*Última actualización: DAY 121 cierre — 18 Abril 2026*
...
*Pubkey activa DAY 121: fc895faac3e8c533d0cf4463637bbb1d2a3fb09dc6e84f7282dc427dd876f238*
*arXiv: 2604.04952 · v15 ✅ · Tag: v0.4.0-phase3-hardening*
*PHASE 3: COMPLETADA ✅ · PHASE 4: feature/adr026-xgboost 75% · BLOQUEANTE: DEBT-PRECISION-GATE-001*
